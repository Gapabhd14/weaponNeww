...
window.addEventListener("load", () => {
    ...
    document.getElementById("creds").addEventListener("click", opencreds);
});
...
const openAlert = (event) => {
    ...
    document.getElementById("sheerClear").style.visibility = "hidden";
    document.getElementById("scrolBut").style.visibility = "hidden";
    document.getElementById("creds").style.visibility = "hidden";
    ...
    document.getElementById("titlePumaLittle").style.display = "none";
    document.getElementById("logo").style.visibility = "hidden";
    document.getElementById("sheerClear").style.visibility = "hidden";
    document.getElementById("scrolBut").style.visibility = "hidden";
    document.getElementById("creds").style.visibility = "hidden";
    ...
    document.getElementById("butTextAlert").style.padding = "0vh";
}

// exam procedure
const procedure = (event) => {
    document.getElementById("arrowpointing").style.display = "none";
    document.getElementById("titlePumaLittle").style.display = "none";
    ...
    document.getElementById("commanderBut").style.visibility = "hidden";
    document.getElementById("butTextAlert").innerText = "אני על זה";
    document.getElementById("alertVideo").style.visibility = "hidden";
    ...
    document.getElementById("butTextAlert").style.padding = "1vh";
}
...
const tretmentPage = (event) => {
    ...
    document.getElementById("startButAlert").style.visibility = "hidden";
    document.getElementById("arrowpointing").style.display = "block";
    setTimeout(() => {
        document.getElementById("arrowpointing").style.display = "none";
    }, 1000);
...
const goBack = () => {
    // document.getElementById("textStartCommander").style.visibility = "hidden";
    // hidden
    document.getElementById("logo").style.visibility = "hidden";
    document.getElementById("sheerClear").style.visibility = "hidden";
    document.getElementById("scrolBut").style.visibility = "hidden";
    ...
    document.getElementById("ultraBack").addEventListener("click", () => {
        document.getElementById("arrowpointing").style.display = "none";
        document.getElementById("explantionPage").style.visibility = "visible";
        document.getElementById("treatmentpage").style.visibility = "hidden";
        document.getElementById("titlePumaLittle").style.display = "none";
...
const opencreds = () => {
    ...
    document.getElementById("sheerClear").style.visibility = "hidden";
    document.getElementById("credspage").style.visibility = "visible";
    document.getElementById("titlePuma").style.visibility = "hidden";
    document.getElementById("scrolBut").style.visibility = "hidden";
    document.getElementById("ultraBack").style.visibility = "visible";
    document.getElementById("ultraBack").style.top = "1vh";
    document.getElementById("ultraBack").style.right = "3vw";
    document.getElementById("ultraBack").addEventListener("click", loadAgain);
}

const loadAgain = () => {
    document.getElementById("arrowpointing").style.display = "none";
    document.getElementById("creds").style.visibility = "visible";
    document.getElementById("logo").style.visibility = "visible";
    document.getElementById("aSide").style.visibility = "visible";
    document.getElementById("sheerClear").style.visibility = "visible";
    document.getElementById("credspage").style.visibility = "hidden";
    document.getElementById("titlePuma").style.visibility = "visible";
    document.getElementById("scrolBut").style.visibility = "visible";
    document.getElementById("ultraBack").style.visibility = "hidden";
}
